...
public class DeadlinePassedNotification {
     ...
     * presentation of deadline passed notifications. Make
     * sure to follow the
    ...
    public static void notify(final Context context,
        ...
        final String text = res.getString(
                R.string.deadline_passed_notification_placeholder_text_template, exampleString);
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_deadline_passed)
